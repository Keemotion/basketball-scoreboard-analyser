define([ "./treenode", "../../messaging_system/event_listener",
		...
		"../../messaging_system/events/add_element_event" ], function(TreeNode,
		EventListener, ReOrderedEvent, AddElementEvent) {
	...
	TreeView.prototype.addNode = function(dataProxy, id) {
		var tree_node = new TreeNode(this.tree_element, dataProxy,
