define([ '../../messaging_system/event_listener',
	'../../messaging_system/events/selection_event' ], function(EventListener, SelectionEvent){
	...
	var TreeNode = function(target_view, parent_node, data_proxy, messaging_system, on_root_level){
		var self = this;
