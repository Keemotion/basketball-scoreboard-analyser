define([ "./proxy/dot_proxy", './coordinate', './data_base_class' ], function(
		DotProxy, Coordinate, DataBaseClass) {
	...
	// when no data is provided, the coordinate is set to be empty and the
	// default properties are applied to this dot
	Dot.prototype.loadData = function(data) {
		if (data == null) {
			...
			this.coordinate = new Coordinate(data.coordinate.x,
					data.coordinate.y);
	...
	// Collects all data about this dot in an Object that can be converted to
	// JSON by the export function
	...
	// return whether the coordinate of this dot is within 5 canvas pixels of
	...
	Dot.prototype.isAtCanvasCoordinate = function(coordinate, transformation) {
		var canvas_coordinate = transformation
				.transformRelativeCoordinateToCanvasCoordinate(this
						.getCoordinate());
	...
	Dot.prototype.getBoundingRectangle = function(rectangle) {
